...
const ManageTravelAndLifestyle = () => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        const docReference = doc(db, 'Catalyst', 'travelAndLifestyle');
        ...
        try {
            if (
                ...
                if (articleToEdit.articleImage instanceof File) {
                    const storageRef = ref(storage, `CatalystArticleImages/travelAndLifestyle/${articleToEdit.articleTitle}-${Date.now()}`);
...
export default ManageTravelAndLifestyle;
