...
const ManageScienceAndTechnology = () => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        const docReference = doc(db, 'Catalyst', 'scienceAndTech');
        ...
        try {
            if (
                ...
                if (articleToEdit.articleImage instanceof File) {
                    const storageRef = ref(storage, `CatalystArticleImages/scienceAndTech/${articleToEdit.articleTitle}-${Date.now()}`);
...
export default ManageScienceAndTechnology;
