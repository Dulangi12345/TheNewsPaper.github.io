            ...
            <form action="" className=''>
                <div className='space-y-12'>
                    ...
                    <div className="border-b border-gray-900/10 pb-12 ">
                        <h2 className="text-base font-semibold leading-7 text-gray-900">Manage Free Articles</h2>
                        ...
                        <option value="3">Article 3</option>
                                ...
                                <label htmlFor="" className='block text-sm font-medium leading-6 text-gray-900'>Article Number</label>
                                <div className='mt-2'>
                                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="number" value={FreeArticleIndex} onChange={handleFreeArticleIndexChange} className='block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900  focus:ring-0 sm:text-sm sm:leading-6' min={1} />
                            ...
                            <div className='col-span-full'>
                                ...
                                <div className='mt-2'>
                                    <input type="text" value={
                                        FreeArticleTitle
                                    } onChange={handleFreeArticleTitleChange} className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' />
                                </div>

                            </div>

                            <div className='col-span-full'>
                                <label htmlFor="" className='block text-sm font-medium leading-6 text-gray-900'>Article Content</label>
                                <p class="mt-3 text-sm leading-6 text-gray-600">Please add spaces between pragraphs for proper distinguishment</p>
                                <div className='mt-2'>
                                    <textarea name="" id="" cols="30" rows="10" value={FreeArticleContent} onChange={handleFreeArticleContentChange} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                    ...
                    /> */}
                            ...
                            <div className='col-span-full'>
                                <h5 className='block text-sm font-medium leading-6 text-gray-900'>Article Header Image 1</h5>
                                    ...
                                    <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                        <div className="text-center">
                                            ...
                                            <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                                <label htmlFor="articleImage1" className='relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500'>
                            ...
                            <div className='col-span-full'>
                                <h5 className='block text-sm font-medium leading-6 text-gray-900'> Article Image 2</h5>
                                ...
                                <div className='col-span-full'>
                                    <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                        ...
                                        <div className="text-center">
                                            ...
                                            <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                                <label htmlFor="articleImage2" className='relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500'>
                            ...
                            <div className='col-span-full'>
                                <h5 className='block text-sm font-medium leading-6 text-gray-900'>Article Image 3</h5>
                                ...
                                <div className='col-span-full'>
                                    ...
                                    <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                        <div className="text-center">
                                            ...
                                            <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                                <label htmlFor="articleImage3" className='relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500'>
                                                    <div>
                                                        Click here to upload
                                                    </div>
                                                    <div className='w-96  h-96'>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    >View Preview</button>
                    <button type="submit" onClick={handleOnSubmit} className='rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>Save</button>
