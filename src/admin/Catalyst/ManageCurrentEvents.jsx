...
const ManageCurrentEvents = () => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        const docReference = doc(db, 'Catalyst', 'currentEvents');
        ...
        try {
            if (
                ...
                if (articleToEdit.articleImage instanceof File) {
                    const storageRef = ref(storage, `CatalystArticleImages/currentEvents/${articleToEdit.articleTitle}-${Date.now()}`);
                    ...
                    <Col md={4}>
                        <div className="rounded overflow-hidden mb-6">
                            <div className="px-6 py-4 items-center">
                                ...
                                <img
                                    className="md:w-96 w-full md:h-56 object-cover mt-4"
                                        ...
                                        {isSaving ? (
                                            <div className="flex items-center">
                                                ...
                                                <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                    ...
                                                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042.86 5.86 2.291 8.209l1.414-1.414zM12 20c-3.042 0-5.86-.86-8.209-2.291l-1.414 1.414A7.962 7.962 0 0012 24v-4zm8.209-2.291A7.962 7.962 0 0020 12h4c0 6.627-5.373 12-12 12v-4zm-2.291-8.209A7.962 7.962 0 0012 4V0c6.627 0 12 5.373 12 12h-4z"></path>
                                                </svg>
                                            </div>
...
export default ManageCurrentEvents;
