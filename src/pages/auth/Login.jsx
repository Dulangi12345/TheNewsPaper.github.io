            ...
            <section className="flex flex-col md:flex-row h-screen items-center">
              ...
              flex items-center justify-center">
                        ...
                        <form className="mt-6" onSubmit={handleLogin}>
                            ...
                            <div className="mt-4">
                                ...
                                <input type="password" name="password"
                                    ...
                                    placeholder="Enter Password" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
                    ...
                    px-4 py-3 mt-6">Log In</button>
                        ...
                        <p className="mt-8">Dont have an account? <Link to="/register" className="text-blue-500 hover:text-blue-700 font-semibold">Register</Link></p>
