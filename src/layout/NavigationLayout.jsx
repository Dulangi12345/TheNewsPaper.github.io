...
const NavigationLayout = () => {
    ...
    return (
        <div>
            <nav className="bg-white lg:rounded-full rounded-3xl m-4 shadow-md border-2 border-gray-100  ">
                <div className="mx-auto max-w-7xl ">
                    <div className="relative flex h-16 items-center justify-between text-center items-baseline ">
